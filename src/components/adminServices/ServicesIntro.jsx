  ...
  return (
    <div>
      <div className="flex w-full items-center justify-between transition duration-1000 ease-in">
        ...
        <button className="bg-[#D7FD44] md:hidden transition duration-1000 ease-in-out text-[1.8rem] font-[500] w-[3rem] h-[3rem] flex items-center justify-center rounded-full">
          +
        </button>
      </div>
